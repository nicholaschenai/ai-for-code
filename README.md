...
- APPS dataset 2021
- [Programming puzzles](https://github.com/microsoft/PythonProgrammingPuzzles) dataset 2021
...
- Approach: retrieval based prompting
    - Retrieval-based Demonstration Selection. uses BM25, SRoBERTa to extract similar code usage examples (to the developer's query) from the demonstration pool. 
    - Template Selection.
